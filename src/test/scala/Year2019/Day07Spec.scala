...
class Day07Spec extends AnyWordSpec with Matchers with ScalaFutures {
  ...
  "Run Amplifiers" should {
    "give the correct output for the given settings" in {
      val programmeCode: Vector[BigInt] = Vector(3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0)
    ...
    "give the correct output for the test case 2" in {
      val programmeCode: Vector[BigInt] = Vector(3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0)
    ...
    "give the correct output for the test case 3" in {
      val programmeCode: Vector[BigInt] = Vector(
