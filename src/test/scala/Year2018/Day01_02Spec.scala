...
class Day01_02Spec extends AnyFeatureSpec {
  ...
  Feature("Callibrator") {
    Scenario("finds the correct repeat of a list of two") {
      ...
      assert(Calibration.scanList(startingFrequency, frequencyShifts) == 0)
    }
    ...
    Scenario("finds the correct repeat of a list of six") {
      ...
      assert(Calibration.scanList(startingFrequency, frequencyShifts) == 2)
    }
    ...
    Scenario("finds the correct repeat of a list of five") {
      ...
      assert(Calibration.scanList(startingFrequency, frequencyShifts) == 10)
    }
    ...
    Scenario("finds the correct repeat of a list") {
      ...
      assert(Calibration.scanList(startingFrequency, frequencyShifts) == 5)
    }
    ...
    Scenario("finds the correct repeat of another list") {
      ...
      assert(Calibration.scanList(startingFrequency, frequencyShifts) == 14)
    }
  }
